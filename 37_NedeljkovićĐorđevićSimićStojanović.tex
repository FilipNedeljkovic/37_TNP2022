...
\begin{document}
	...
	\author{
    Filip Nedeljković\\
    mi22043@alas.matf.bg.ac.rs
    \and
    Matija Đorđević\\
    mi22059@alas.matf.bg.ac.rs
    \and
    Mlađan Simić\\
    mi22090@alas.matf.bg.ac.rs
    \and
    Igor Stojanović\\
    mi22159@alas.matf.bg.ac.rs
    }
	\date{\today}
	\maketitle
	...
	obe tehnologije veoma brzo šire, postaju dostupne sve većem broju ljudi, a svakim danom im se pronalaze nove potencijalne upotrebe.\cite{Proširena stvarnost}
    ...
    Od početka civilizacije, ljudi su težili unapređenju svog okruženja. Rani pokušaji obuhvatali su manipulaciju objekata u fizičkom smislu a kako se čovečanstvo razvijalo,
	 ideje su dobile vodeći značaj.\cite{Istorija 1 i način rada} Uz pomoć novih uređaja i pomagala, ulazi se u vreme u kome nestaju granice između fizičkog i idejnog sveta.\\
	...
	Prototip se sadržao od displeja postavljenog preko cele glave korisnika sa brojnim kablovima povezanim na velike kompjutere(slika \ref{fig:Rani prototip}). Iako primitivan, sistem je omogućavao prikaz
    ...
    \begin{itemize}
     ...
     \item ekran
    \end{itemize}
	Svaka od ovih tri stavki vrši drugačije uloge u zavisnosti od napravljene aplikacije.\cite{Istorija 1 i način rada}
	\subsection{Senzor}
    \label{sec:Senzor}
	...
	Isto kao i vizualni displej, može se podeliti na: stacionarski vizualni displej, vizualni displej koji se pomera sa glavom korisnika, vizualni displej koji se pomera sa rukom ili drugim delovima tela korisnika.\cite{Istorija 1 i način rada} \\
	...
	implementaciju  u AR aplikaciji.\cite{Istorija 1 i način rada}
	...
	jeste mogućnost neposredne interakcije sa fizički nedostupnim objektima i upoznavanje sa predmetima i situacijama na interesantan i razumljiv način.
        ...
        \bibitem{Primena AR tehnologije obrazovanju 1} E. Solak i R. Cakir. \emph{Investigating the Role of Augmented Reality Technology in the Language Classroom.} Amasija, 
	Turska, 2015.
        \bibitem{Proširena stvarnost} P. Pleše. \emph{Proširena stvarnost.} Zagreb, Hrvatska, 2019.
        \bibitem{Upotreba AR tehologije u obrazovanju 2} K. Mitrović, J. Čurčić, A. Jakšić, B. Bogojević i D. Gračanin. \emph{Primena tehnologije virtuelne I proširene 
	stvarnosti u obrazovanju.} Novi Sad, Srbija, 2020.
        \bibitem{Upotreba kod dece sa intelektualnim teškoćama} K. Stančin. \emph{Upotreba informacijsko-komunikacijske tehnologije u odgoju i obrazovanju učenika s 
	intelektualnim teškoćama.} Zagreb, Hrvatska, 2018.
        \bibitem{Istorija 1 i način rada} A. B. Craig. \emph{Understanding Augmented Reality: Concepts and Applications.} Ilinois, Sjedinjene Američke 
	Države, 2013.
		\bibitem{Istorija 2} M. Billinghurst, A. Clark, G. Lee. \emph{A Survey of Augmented Reality.} Christchurch, Australia, 2015.
        \bibitem{Istorija 3} J. Carmigniani, B. Furht. \emph{Augmented Reality: An Overview.} Florida, Sjedinjene Američke Države.
